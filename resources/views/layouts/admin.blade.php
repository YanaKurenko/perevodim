    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{ url('/') }}" class="logo">
                ...
                <span class="logo-lg"><b>Perevodim</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src='{{ asset("images/icons/news.jpg")}}' class="user-image" alt="User Image">
                                <span class="hidden-xs">{{Auth::user()->name}}</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src='{{ asset("images/icons/news.jpg")}}' class="img-circle" alt="User Image">
                                    <p>{{Auth::user()->name}}</p>
                                </li>
        ...
        <footer class="main-footer">
            ...
            <strong>Kurenko | Yana | 2022</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
